...
;; in this problem numbers are passed around multiplied , added ,
;; multiplied some more , checked if divisible by a certain prime
;; passed somewhere else dependent on if condition was true or false
;;
;; 
;; Let us write some FACTS 
;; fact 1 : monkey throws item to a different monkey 
;; fact 2 : there is a finite number of items
;; fact 3 : the most items any monkey can have is all the items from the start state
;; 
;;
